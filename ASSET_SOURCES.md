...
Source: the anonymous ICRA submission cut, 1920 x 1080 at 30 fps, 133.434
seconds. Its original timing, soundtrack, benchmark graphics, and reported
values are preserved. The second-stage card contains the corrected RPE-T mean,
and the closing page (02:05.433-02:13.433) uses the pseudonymous GitHub URLs.
The title card (00:12.033-00:19.633) names no author or institution.
The second-stage refinement card at 00:53.233-01:00.233 reports RPE-T mean
`3.536 -> 2.610`, RPE-T median `3.624 -> 2.600`, and arc-length ratio
`0.755 -> 1.112`.
`assets/media/mint-film-compact.mp4` is the updated CRF 23 encode (20.8 MiB),
and `assets/media/mint-film-720p.webm` is the 720p VP9 fallback (21.2 MiB).
